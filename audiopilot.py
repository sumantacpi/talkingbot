...
client = OpenAI(api_key="sk-proj-nWV0c9C6VA19qIlzkALHT3BlbkFJJkxxo3syTSuQyXq0hqLL")
import os
...
# Streamlit app header and title
st.set_page_config(page_title="Custom Speech-enabled Copilot | By Sumanta Basu Cognizant", page_icon=logo1 , layout="wide")
...
def generate_response(prompt, temperature=0.7, max_tokens=256, top_p=0.9, n=2, stop=None, frequency_penalty=0.9, presence_penalty=0.9, chat_history=None):
    ...
    messages = [
        {"role": "system", "content": "You are exper ABAP Developer."},
...
logtxtbox = st.empty()
logtxt = '-->'
logtxtbox.text_area("You Asked:",logtxt, height = 250)

text = whisper_stt(openai_api_key="sk-proj-nWV0c9C6VA19qIlzkALHT3BlbkFJJkxxo3syTSuQyXq0hqLL", language = 'en')  



st.write("# Cognizant Copilot By Sumanta Basu with GPT-3.5-turbo :sunglasses: ")
#st.write("Made with love by - [Anish Singh Walia](https://anishsinghwalia.medium.com/)")
st.write("Welcome to your Custom Chatbot! Type your message below:")
...
for message in messages:
    if message["role"] == "user":
        ...
        st.text_area("Cognizant:", value=message["content"], height=500, key="chatbot_history")
